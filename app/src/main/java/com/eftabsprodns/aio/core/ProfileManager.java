package com.eftabsprodns.aio.core;
...
public class ProfileManager {
    ...
    public void saveProfileList(Context context) {
        SharedPreferences sharedprefs = context.getSharedPreferences(PREFS_NAME, AppCompatActivity.MODE_PRIVATE);
    ...
    private void saveProfile(Context context, VpnProfile profile, boolean updateVersion) {
        ...
        try {
            vpnfile = new ObjectOutputStream(context.openFileOutput((profile.getUUID().toString() + ".vp"), AppCompatActivity.MODE_PRIVATE));
    ...
    private void loadVPNList(Context context) {
        ...
        SharedPreferences listpref = context.getSharedPreferences(PREFS_NAME, AppCompatActivity.MODE_PRIVATE);
