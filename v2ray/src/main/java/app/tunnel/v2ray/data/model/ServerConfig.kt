...
import app.tunnel.v2ray.common.V2RayConstants.TAG_BLOCKED
import app.tunnel.v2ray.common.V2RayConstants.TAG_DIRECT
...
data class ServerConfig(
    ...
    fun getV2rayPointDomainAndPort(): String {
        ...
        return if (V2RayUtils.isIpv6Address(address)) {
